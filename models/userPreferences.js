...
userSchema.methods.updatePreferences = function (preferences) {
    const { language, emailNotifications, dailyReportSubscription, telegramNotifications, todoReminders, shoppingNotifications, lowStockAlerts, theme } = preferences;

    this.language = language || this.language;
    this.emailNotifications = emailNotifications !== undefined ? emailNotifications === 'on' : false;
    this.dailyReportSubscription = dailyReportSubscription !== undefined ? dailyReportSubscription === 'on' : false;
